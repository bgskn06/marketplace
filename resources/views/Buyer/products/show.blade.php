                                    ...
                                    @auth
                                        ...
                                        @if ($canRate)
                                            <form method="POST"
                                                ...
                                                <div>
                                                    <button type="submit"
                                                        class="px-4 py-2 bg-indigo-600 text-white rounded-md">Kirim
                                                        Ulasan</button>
                                                </div>
                                            </form>
                                        @else
                                        ...
                                        @endif
                                    @else
                                        <div class="text-sm text-gray-600">Silakan <a href="{{ route('login') }}"
                                                class="text-indigo-600">login</a> untuk memberi rating.</div>
                                    @endauth
                                            ...
                                            <div class="border rounded p-3">
                                                <div class="text-sm font-medium text-gray-800">
                                                    {{ $review->user->name ?? 'User' }} • <span
                                                        class="text-yellow-500">{{ $review->rating }} ★</span></div>
                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        ...
                        @if ($product->shop)
                            <a href="{{ route('shops.show', $product->shop) }}"
                                class="mt-3 inline-block text-indigo-600">Lihat Toko</a>
                        @else
