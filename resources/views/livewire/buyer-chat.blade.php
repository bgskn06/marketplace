<div class="row">
    ...
    <div class="col-md-4 mb-4">
        <div class="card shadow-sm h-100">
            ...
            <div class="list-group list-group-flush" style="height: 500px; overflow-y: auto;">
                ...
                <a href="javascript:void(0)" wire:click="selectConversation({{ $conv->id }})" class="list-group-item list-group-item-action {{ $isActive ? 'active' : '' }}">
    ...
    <div class="col-md-8 mb-4">
        <div class="card shadow-sm" style="height: 580px;"> {{-- Tinggi fix card --}}
            ...
            <div id="chat-box" wire:poll.2000ms class="card-body overflow-auto d-flex flex-column" style="height: 400px; background-color: #f8f9fa;">
                @php
                $lastDate = null;
                @endphp
                ...
                <div class="chat {{ $isMe ? 'chat-end' : 'chat-start' }}">
                    <div class="chat-image avatar">
                        <div class="w-10 rounded-full">
                            <img alt="Avatar" src="https://ui-avatars.com/api/?name={{ urlencode($sender->name) }}&background=random" />
                        </div>
                    </div>
                    ...
                    <div class="chat-bubble {{ $isMe ? 'chat-bubble-primary text-white' : 'chat-bubble-secondary' }}">
                        {{ $msg->body }}
                    </div>
                    <div class="chat-footer opacity-50">
                        @if ($isMe)
                        <i class="fas {{ $msg->is_read ? 'fa-check-double text-blue-500' : 'fa-check' }}"></i>
                        @endif
                    </div>
                </div>
                @endforeach
            ...
            <div class="card-footer bg-white">
                <form wire:submit.prevent="sendMessage">
                    <div class="input-group">
                        <input type="text" wire:model="body" class="form-control" placeholder="Tulis pesan..." required>
